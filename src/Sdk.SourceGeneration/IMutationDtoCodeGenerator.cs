...
/// <summary>
///     Interface for generates code for mutation DTO's
/// </summary>
public interface IMutationDtoCodeGenerator : IEquatable<IMutationDtoCodeGenerator>
{
   /// <summary>
   /// Generates code for a type for GraphQL mutations
   /// </summary>
   ...
   /// <summary>
   /// Generates code for a record for GraphQL mutations
   /// </summary>
   /// <param name="ns">The namespace of the created code</param>
